...
public class Article {
    ...
    public void setItemState(ItemState itemState) { this.itemState = itemState; }

    public BigDecimal getPurchasePrice() { return purchasePrice; }
    public void setPurchasePrice(BigDecimal purchasePrice) { this.purchasePrice = purchasePrice; }

    public boolean hasStock() { return amount > 0; }
    public String getStockStatus() { return hasStock() ? "Disponible" : "Sin Stock"; }
    public boolean requireWeigthForPawn(){ return category != null && category.requiresWeight(); }

    @Override
    public String toString() { return nameArticle; }
}